            ...
            >
              ...
              <button
                onClick={() => {
                  ...
                  const message = encodeURIComponent(`Hola! Tengo dudas sobre el producto: ${product?.name}`);
                  window.open(`https://wa.me/${phone}?text=${message}`, '_blank');
                }}
                className="w-full text-white px-4 py-2 rounded-lg transition-all duration-200 font-medium text-center flex items-center justify-center gap-2"
