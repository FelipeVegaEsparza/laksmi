...
SELECT TABLE_NAME, TABLE_ROWS FROM information_schema.TABLES WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME IN ('bookings', 'company_settings', 'banners', 'featured_images') ORDER BY TABLE_NAME;
