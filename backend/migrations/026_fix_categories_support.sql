-- ============================================
-- Migración 026: Corregir soporte de categorías múltiples
-- ============================================
-- Esta migración corrige el problema de tipos de datos incompatibles
-- Primero verificamos el tipo de dato de services.id y products.id

-- Crear tabla service_categories con VARCHAR en lugar de CHAR
...
-- Crear tabla product_categories con VARCHAR en lugar de CHAR
